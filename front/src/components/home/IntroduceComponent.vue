<template>
  <el-row class="row-bg" justify="space-evenly">
    <el-col :span="4.8"
      ...
      >
        ...
        <div class="text item part-desc">
          集中管理和提供各种资源，用户可方便地浏览、搜索和获取所需的资源，提高工作效率
        </div>
      </el-card>
    </el-col>
    ...
    <el-col :span="4.8"
      ...
      <el-card
        class="box-card"
        :class="{ Large: this.isLarge[3] }"
        id="3"
        @click="jumpToimg"
      >
        <div class="card-header">
          <MapLocation class="iconclass"></MapLocation>
          <h2 class="part-title">水运一张图</h2>
        </div>
        <div class="text item part-desc">
          汇集水运数据，可视化展示船舶位置、航线和海事信息，助力海事决策
        </div>
      </el-card>
    </el-col>
    ...
    <el-col :span="4.8"
      ...
      >
        ...
        <div class="text item part-desc">
          收集、处理和分析数据，帮助用户获取有关业务、市场和用户行为的深入见解
        </div>
      </el-card>
    </el-col>
...
.box-card {
  ...
  height: 20vh;
  color: #fff;
  background-color: rgba(43, 47, 51, 0.562);
  &:hover {
    background-color: cadetblue;
    color: aqua;
    cursor: pointer;
